    ...
    <div>
      ...
      <div
        className='border flex border-gray-200
                   w-[212.34px] h-[65.6px] p-4 rounded-[12px] bg-white
                   transition
      ...
      <div
        className='border flex border-gray-200
                   w-[250.34px] h-[65.6px] p-4 rounded-[12px] bg-white
                   transition
                   hover:shadow-[0_6px_18px_rgba(0,0,0,0.15)]'
      >
        ...
        <div className='ml-3'>
          <h4 className='text-[14px] font-bold'>Marketing_Strategy.pptx</h4>
          <p className='text-[12px] text-gray-500'>2.2 MB</p>
        </div>
      </div>
      <div
      ...
      <div
        className='border flex border-gray-200
                   w-[235.34px] h-[65.6px] p-4 rounded-[12px] bg-white
                   transition
                   hover:shadow-[0_6px_18px_rgba(0,0,0,0.15)]'
      >
      ...
      <div className='flex mt-7 text-[14px] text-[#737373] font-semibold justify-around'>
        ...
        <h4 className='text-[14px] text-[#171717]'>Financial_Report.xlsx</h4>
        </div>
        <h4>1.5 MB</h4>
        <h4>07 Aug 2024</h4>
      ...
      <div className='flex mt-7 text-[14px] text-[#737373] font-semibold justify-around'>
        ...
        <h4 className='text-[14px] text-[#171717]'>Project_Presentation.pptx</h4>
        </div>
        <h4>3.1 MB</h4>
        <h4>24 Aug 2024</h4>
      ...
      <div className='flex mt-7 text-[14px] text-[#737373] font-semibold justify-around'>
        ...
        <h4 className='text-[14px] text-[#171717]'>Project_Summary.docx</h4>
        </div>
        <h4>987.7 kB</h4>
        <h4>29 Oct 2024</h4>
      ...
      <div className='flex mt-7 text-[14px] text-[#737373] font-semibold justify-around'>
        <div className='items-center flex gap-2'>
        <img src={gallery} alt="" className='h-[30px] w-[30px] '/>
        <h4 className='text-[14px] text-[#171717]'>Colorful_donunt.jpg</h4>
        </div>
        <h4>216.8 kB</h4>
        <h4>11 Dec 2024</h4>
      ...
      <div className='flex mt-7 text-[14px] text-[#737373] font-semibold justify-around'>
        <div className='items-center flex gap-2'>
        <img src={notepad} alt="" className='h-[30px] w-[25px] '/>
        <h4 className='text-[14px] text-[#171717]'>Research_Paper.docx</h4>
        </div>
        <h4>987.7 kB</h4>
        <h4>23 Jan 2025</h4>
      ...
      <div className='flex mt-7 text-[14px] text-[#737373] font-semibold justify-around'>
        ...
        <h4 className='text-[14px] text-[#171717]'>Architecture_Diagram.fig</h4>
        </div>
        <h4>456.8 kB</h4>
        <h4>11 Dec 2024</h4>
        <h4 className='mr-2'>11 Dec 2024</h4>
